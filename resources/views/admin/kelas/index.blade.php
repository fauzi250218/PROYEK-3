...
@section('content')
<div class="container-fluid kelas-index-page px-4">

    <!-- ================= HEADER ================= -->
    <div class="d-flex justify-content-between align-items-center kelas-header">
        <div>
            <h2 class="fw-bold text-dark mb-1">Data Kelas</h2>
            <p class="text-muted small mb-0">
                Kelola seluruh kelas dan wali kelas yang terdaftar
            </p>
        </div>
        <a href="{{ route('admin.kelas.create') }}"
           class="btn btn-main px-4 py-2 rounded-3 shadow-sm">
            Tambah Kelas
        </a>
    </div>
    ...
    <!-- ================= NOTIFIKASI ================= -->
    @if(session('success'))
        <div class="alert alert-success alert-dismissible fade show shadow-sm my-4" role="alert">
            ...
            <div class="row g-4">
                @foreach($daftar as $k)
                    <div class="col-lg-4 col-md-6">
                        <div class="kelas-card bg-white border shadow-sm">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">
                                            {{ $k->guru->user->name ?? 'Belum ada wali kelas' }}
                                        </small>
                                    </div>
                                </div>
